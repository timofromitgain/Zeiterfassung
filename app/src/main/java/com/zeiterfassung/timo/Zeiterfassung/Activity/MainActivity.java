...
import com.zeiterfassung.timo.Zeiterfassung.Interface.ITaetigkeitsbericht;
import com.zeiterfassung.timo.Zeiterfassung.Interface.IdataLoaded;
...
// textView is the TextView view that should display it
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case com.zeiterfassung.timo.Zeiterfassung.R.id.nav_logout:
