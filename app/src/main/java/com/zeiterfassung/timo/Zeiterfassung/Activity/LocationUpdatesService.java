...
String key;
    ...
    private static final String TAG = "loc123";
    ...
    public void onCreate() {
        ...
        locIntervalls = new HashMap<String, Integer>();
    ...
    private Notification getNotification() {
        ...
        PendingIntent activityPendingIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, KarteActivity.class), 0);

        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.drawable.ic_anrufen, "",
                        activityPendingIntent)
                .addAction(R.drawable.ic_bericht, "",
    ...
    private void onNewLocation(Location location) {
        ...
        wert =  locIntervalls.get(key);
        wert++;
        locIntervalls.put(key,wert);
    ...
    //    mLocationRequest.setInterval(UPDATE_INTERVAL_IN_MILLISECONDS);
      //  mLocationRequest.setFastestInterval(FASTEST_UPDATE_INTERVAL_IN_MILLISECONDS);
        ...
        mLocationRequest.setFastestInterval(5500);
